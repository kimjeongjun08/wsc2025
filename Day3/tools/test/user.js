...
export const options = {
  stages: [
    { duration: '0s', target: 200 },    // 즉시 100명으로 시작
    { duration: '5m', target: 200 },    // 5분간 100명 유지
    { duration: '0s', target: 500 },    // 즉시 500명으로 변경
    { duration: '5m', target: 500 },    // 5분간 500명 유지
    { duration: '0s', target: 200 },   // 즉시 1000명으로 변경
    { duration: '5m', target: 200 },  // 10분간 1000명 유지
    { duration: '0s', target: 1000 },   // 즉시 1200명으로 변경
    { duration: '5m', target: 1000 },   // 5분간 1200명 유지
    { duration: '0s', target: 500 },   // 즉시 2500명으로 변경
    { duration: '5m', target: 500 },   // 5분간 2500명 유지
    { duration: '0s', target: 300 },    // 즉시 100명으로 감소
    { duration: '5m', target: 300 },    // 5분간 100명 유지
  ],
  thresholds: {
